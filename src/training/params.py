...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Whether to use raking ratio redistribution.",
    )
    parser.add_argument(
        "--num-raking-rounds",
        type=int,
        default=2,
        help="Number of Sinkhorn projection rounds for raking ratio estimate.",
    )
    parser.add_argument(
        "--quantization",
        type=str,
        default="/mnt/ssd/ronak/datasets/imagenet_captions/vit_b32_laion2b_kmeans_50",
        help="Prefix for quantization method raking ratio estimate.",
    )
    parser.add_argument(
        "--overwrite",
        default=False,
        action="store_true",
        help="Overwrite current log directory.",
    )
